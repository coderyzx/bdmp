 ...
 class MenuPage extends React.Component {
   ...
   render() {
     ...
     const {confirmLoading,visible,loading,deleteLoading,selectedRowKeys,visible3,iconLoading} = this.state;
     const rowSelection = {
       selectedRowKeys,
       ...
       <div style={{ margin: '0 50px' }}>  
         ...
         >
           <p className={styles.selectItem}>
             确认删除所选择的<b>{hasSelected ? `${selectedRowKeys.length}项` : ''}</b>吗？
           </p>
           <Icon type="delete" style={{ color:'red',fontSize: 40,}}/>
         </Modal>
         <EditableForm
